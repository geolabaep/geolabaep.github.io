...
function renderMethodology(){
 ...
 <div class="method-v101-layout">
  ...
  <div class="method-v101-section method-v101-wide"><h3>4. Procesamiento e indicadores</h3><div class="method-v101-mini-grid"><div class="method-v101-mini"><b>Nivel</b><span>Lectura hidrométrica expresada siempre en metros.</span></div><div class="method-v101-mini"><b>Variación diaria</b><span>Diferencia contra el registro anterior. Cambios menores a 1 m se muestran en cm; cambios iguales o mayores a 1 m, en m.</span></div><div class="method-v101-mini"><b>Tendencia de 7 días</b><span>Comparación con el registro disponible más cercano a siete días antes.</span></div><div class="method-v101-mini"><b>Tendencia de 30 días</b><span>Comparación con el registro disponible más cercano a treinta días antes.</span></div><div class="method-v101-mini"><b>Días consecutivos</b><span>Cuenta la persistencia de ascensos, descensos o estabilidad a partir de observaciones consecutivas.</span></div><div class="method-v101-mini"><b>Posición histórica</b><span>Ubicación porcentual del nivel actual entre el mínimo y máximo históricos de referencia.</span></div></div></div>
...
function tendenciaTablaHtml(){
 ...
 if(!rows.length)return '<div class="ops-v4-empty">No hay estaciones actualizadas para calcular tendencias.</div>';
 const signal=(delta)=>{
 ...
 const summary=`<div class="ops-trend-summary">
  <div class="ops-trend-summary-card"><div class="ops-trend-summary-label">Tendencias sostenidas</div><div class="ops-trend-summary-value">${sostenidos}</div><div class="ops-trend-summary-name">Señal semanal y mensual en la misma dirección</div></div>
...
function opsSynthesisHtml(c,pct,trendTxt,ex,semanal,mensual,revisar,subidas,bajadas,rios){
 ...
 return `<div class="ops-synthesis-box">
  ...
  <div class="ops-synthesis-section"><div class="ops-synthesis-label">Situación hidrológica</div><p class="ops-synthesis-text">Tendencia dominante: <b>${trendTxt}</b>. La lectura integra variación diaria y comparación 7/30 días.</p><div class="ops-synthesis-bullets">${riosTxt}</div></div>
...
function renderOps(){
 ...
 ].join('')}</div></div><div class="ops-focus-section"><div class="ops-focus-title">Tendencia comparativa</div><div class="ops-focus-grid periods">${[
 ...
 ].join('')}</div></div><div class="ops-focus-note"><span><b>Variación de la fecha consultada:</b> cambio diario calculado contra el registro anterior disponible.</span><span><b>Tendencia comparativa:</b> las variaciones de 7 y 30 días muestran continuidad o reversión reciente.</span><span><b>Uso operativo:</b> comparación contextual, no reemplaza umbrales oficiales ni pronósticos.</span></div></div>`;
 html+=`<div class="ops-compact-card"><h3>Matriz operativa de tendencias</h3><div class="ops-compact-sub">Compara el cambio de la fecha consultada con señales de 7 y 30 días para priorizar revisión técnica.</div>${tendenciaTablaHtml()}</div>`;
